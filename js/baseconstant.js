...
var baseImgUrls="http://192.168.31.107:9100/"
//获取新闻详情页面
function getNewsDetail(newsid) {
	$.ajax({
		url: baseUrls + "news/getNewsDetail",
		data: {
			newsid: newsid
		},
		success: function(res) {
...
//获取公告详情
function getAnnouncementDetail(annid) {
	$.ajax({
		url: baseUrls + "news/getAnnouncementDetail",
		data: {
			annid: annid
		},
		success: function(res) {
			if (res.code === 200) {
				sessionStorage.setItem("announcementDetail", JSON.stringify(res.msg));
